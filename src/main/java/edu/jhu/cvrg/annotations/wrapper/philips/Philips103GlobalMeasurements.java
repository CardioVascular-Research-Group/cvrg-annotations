...
public class Philips103GlobalMeasurements implements GlobalMeasurements {

	private Globalmeasurements globalMeasurements;
	
	public Philips103GlobalMeasurements(Globalmeasurements globalMeasurements){
		this.globalMeasurements = globalMeasurements;
	}
